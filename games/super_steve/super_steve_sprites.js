...
class SuperSteveSprites {
    ...
    loadSprites() {
        ...
        this.sprites.stand_anim.img.src = './games/super_steve/super_steve_stand_anim.png';
        this.sprites.walk.img.src = './games/super_steve/super_steve_walk.png';
        this.sprites.jump.img.src = './games/super_steve/super_steve_jump.png'; // Feltételezve, hogy létezik egy ugrás kép is
